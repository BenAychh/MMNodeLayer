...
describe('a user makes a request to see the list of users they are interested in', () => {

    it('should return the list given a valid token', done => {
        chai.request(server)
            .get('/matches/getinterest?token=' + teacherToken)
            .end((err, res) => {
    ...
    it('should return an error given no token', done => {
        chai.request(server)
